    ...
    <div className="col-xl-6 col-md-7 d-flex flex-column mx-auto criar">
      <div className="container-fluid py-4 form">
        <div className="card shadow-lg mx-4 form-card-padding color-card">
          <h4 className="text-center font-weight-bolder text-color">Novo Utilizador</h4>
            ...
            <form>
              ...
              <div className="row row-form">
                <div className="col-md-6 mb-3">
                  ...
                  <select className="form-control" name="Cargo" id="Cargo" value={campCargo}
                    ...
                    {/*{managers.map((manager, index) => (
                      <option key={index} value={manager}>
                        {manager}
                      </option>))} */}<option>Colaborador</option>
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <select className="form-control" name="Manager" id="Manager" value={campManager}
                ...
                <div className="mb-3">
                  <label class="form-label" for="customFile">Inserir Contrato</label>
                  <input type="file" class="form-control" id="customFile" value={campContrato}
